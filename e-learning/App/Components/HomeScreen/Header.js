...
import moeda from '../../../assets/images/coin.png';
      ...
      <View>
        <View style={[{ justifyContent: 'space-between' }, styles.rowStyle]}>
          <View style={styles.rowStyle}>
            ...
            <View>
              <Text
                style={{ color: Colors.WHITE, fontFamily: 'outfit_regular' }}
              >
                Bem vindo,
              </Text>
          ...
          <View style={styles.rowStyle}>
            <Image source={moeda} style={{ width: 35, height: 35 }} />
        ...
        >
          <TextInput
            ...
            style={{ fontFamily: 'outfit_regular', fontSize: 18 }}
          />
